...
class Processeur
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Produits::class, mappedBy="processeur", orphanRemoval=true)
     */
    private $produits;
    ...
    public function removeProduit(Produits $produit): self
    {
        if ($this->produits->removeElement($produit)) {
            ...
            if ($produit->getProcesseur() === $this) {
                $produit->setProcesseur(null);
            }
        }
