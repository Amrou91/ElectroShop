...
class CarteGraphique
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Produits::class, mappedBy="carteGraphique", orphanRemoval=true)
     */
    private $produits;
    ...
    public function addProduit(Produits $produit): self
    {
        if (!$this->produits->contains($produit)) {
            ...
            $produit->setCarteGraphique($this);
        }
    ...
    public function removeProduit(Produits $produit): self
    {
        if ($this->produits->removeElement($produit)) {
            ...
            if ($produit->getCarteGraphique() === $this) {
                $produit->setCarteGraphique(null);
            }
        }
